# -*- coding: utf-8 -*-
"""Копия блокнота "ДЗ_Библиотека.ipynb"

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tYmgNjDSxoIXsbdix8-OeITStaRZuHgt
...
R = 8.3144598
GAS_INFO = [
    {"name":"Уренгойское", 'CH': [98.4, 0.1, 0, 0, 0], 'N2': 1.2, 'CO2':0.3},
    {"name":"Ямбургское", 'CH': [98.6, 0.1, 0, 0, 0], 'N2': 1.2, 'CO2':0.1},
    {"name":"Заполярное", 'CH': [99.3, 0.1, 0, 0, 0], 'N2': 0.4, 'CO2':0.2},
    {"name":"Медвежье", 'CH': [97.3, 1, 0.1, 0.1, 0.1], 'N2': 0.5, 'CO2':0.5},
    {"name":"Оренбургское", 'CH': [83.77, 4.6, 1.64, 0.81, 1.88], 'N2': 4.34, 'CO2':0.87},
    {"name":"Вуктыльское", 'CH': [75.1, 8.9, 3.6, 1.5, 6.4], 'N2': 4.4, 'CO2':0.1},
    {"name":"Шебелинское", 'CH': [92.07, 3.26, 0.59, 0.18, 0.6], 'N2': 1.3, 'CO2':2},
    {"name":"Газлинское", 'CH': [96.9, 1.74, 0.04, 0.01, 0.01], 'N2': 1.15, 'CO2':0.15},
    {"name":"Астраханское", 'CH': [90.48, 2.07, 0.99, 1.75, 0.61], 'N2': 3.45, 'CO2':0.65},
    {"name":"Тест", 'CH': [90.48, 0, 0.99, 1.75, 0.61], 'N2': 3.45, 'CO2':0.65}
    ]
...
def PV_RT ():
  P = input('Ввод давления: ') or None
  V = input('Ввод объем: ') or None
  Tg = input('Ввод температура: ') or None
  if (P):
    if (Tg):
      if (V):
        print("ошибка")
